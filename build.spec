...
] + collect_data_files("flet_desktop") + collect_data_files("pykakasi") + collect_data_files("unidic_lite") + collect_data_files("cutlet") + collect_data_files("langdetect") + collect_data_files("jieba") + collect_data_files("spellchecker")
